...
class Smiles_embedding(nn.Module):
	...
	def forward(self, sequence, pos_num, adj_mask=None, adj_mat=None):
		...
		if adj_mat is not None:
			...
			#print("adj_mask.shape:",adj_mask,adj_mask.shape)
...
class Adjacency_embedding(nn.Module):
	...
	def forward(self, input_mat):
		#print("input_mat1:",input_mat,input_mat.size())
		a_w = torch.matmul(input_mat, self.weight_h)
		#print("weight_h:",self.weight_h,self.weight_h.size())
		#print("input_mat2:",input_mat,input_mat.size())
		#print("a_w",a_w,a_w.size())
